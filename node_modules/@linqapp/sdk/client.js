...
var _LinqAPIV3_instances, _a, _LinqAPIV3_encoder, _LinqAPIV3_baseURLOverridden;
Object.defineProperty(exports, "__esModule", { value: true });
exports.LinqAPIV3 = void 0;
...
const attachments_1 = require("./resources/attachments.js");
const capability_1 = require("./resources/capability.js");
const contact_card_1 = require("./resources/contact-card.js");
const messages_1 = require("./resources/messages.js");
const phone_numbers_1 = require("./resources/phone-numbers.js");
const phonenumbers_1 = require("./resources/phonenumbers.js");
const webhook_events_1 = require("./resources/webhook-events.js");
const webhook_subscriptions_1 = require("./resources/webhook-subscriptions.js");
...
class LinqAPIV3 {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('LINQ_API_V3_BASE_URL'), apiKey = (0, env_1.readEnv)('LINQ_API_V3_API_KEY'), ...opts } = {}) {
        _LinqAPIV3_instances.add(this);
        _LinqAPIV3_encoder.set(this, void 0);
         ...
         *
         */
        this.attachments = new API.Attachments(this);
        /**
         ...
         *
         */
        this.contactCard = new API.ContactCard(this);
        if (apiKey === undefined) {
            throw new Errors.LinqAPIV3Error("The LINQ_API_V3_API_KEY environment variable is missing or empty; either provide it, or instantiate the LinqAPIV3 client with an apiKey option, like new LinqAPIV3({ apiKey: 'My API Key' }).");
        }
        const options = {
            apiKey,
            ...opts,
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('LINQ_API_V3_LOG'), "process.env['LINQ_API_V3_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _LinqAPIV3_encoder, Opts.FallbackEncoder, "f");
        const customHeadersEnv = (0, env_1.readEnv)('LINQ_API_V3_CUSTOM_HEADERS');
        if (customHeadersEnv) {
            const parsed = {};
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _LinqAPIV3_instances, "m", _LinqAPIV3_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _LinqAPIV3_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.LinqAPIV3 = LinqAPIV3;
_a = LinqAPIV3, _LinqAPIV3_encoder = new WeakMap(), _LinqAPIV3_instances = new WeakSet(), _LinqAPIV3_baseURLOverridden = function _LinqAPIV3_baseURLOverridden() {
    return this.baseURL !== 'https://api.linqapp.com/api/partner';
};
LinqAPIV3.LinqAPIV3 = _a;
LinqAPIV3.DEFAULT_TIMEOUT = 60000; // 1 minute
LinqAPIV3.LinqAPIV3Error = Errors.LinqAPIV3Error;
LinqAPIV3.APIError = Errors.APIError;
LinqAPIV3.APIConnectionError = Errors.APIConnectionError;
LinqAPIV3.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
LinqAPIV3.APIUserAbortError = Errors.APIUserAbortError;
LinqAPIV3.NotFoundError = Errors.NotFoundError;
LinqAPIV3.ConflictError = Errors.ConflictError;
LinqAPIV3.RateLimitError = Errors.RateLimitError;
LinqAPIV3.BadRequestError = Errors.BadRequestError;
LinqAPIV3.AuthenticationError = Errors.AuthenticationError;
LinqAPIV3.InternalServerError = Errors.InternalServerError;
LinqAPIV3.PermissionDeniedError = Errors.PermissionDeniedError;
LinqAPIV3.UnprocessableEntityError = Errors.UnprocessableEntityError;
LinqAPIV3.toFile = Uploads.toFile;
LinqAPIV3.Chats = chats_1.Chats;
LinqAPIV3.Messages = messages_1.Messages;
LinqAPIV3.Attachments = attachments_1.Attachments;
LinqAPIV3.Phonenumbers = phonenumbers_1.Phonenumbers;
LinqAPIV3.PhoneNumbers = phone_numbers_1.PhoneNumbers;
LinqAPIV3.WebhookEvents = webhook_events_1.WebhookEvents;
LinqAPIV3.WebhookSubscriptions = webhook_subscriptions_1.WebhookSubscriptions;
LinqAPIV3.Capability = capability_1.Capability;
LinqAPIV3.Webhooks = webhooks_1.Webhooks;
LinqAPIV3.ContactCard = contact_card_1.ContactCard;
