...
export declare class Capability extends APIResource {
     ...
     * ```
     */
    checkiMessage(body: CapabilityCheckiMessageParams, options?: RequestOptions): APIPromise<HandleCheckResponse>;
    /**
...
export declare namespace Capability {
    export { type HandleCheck as HandleCheck, type HandleCheckResponse as HandleCheckResponse, type CapabilityCheckiMessageParams as CapabilityCheckiMessageParams, type CapabilityCheckRCSParams as CapabilityCheckRCSParams, };
}
